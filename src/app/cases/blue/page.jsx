         ...
         <div className="md:w-3/4 w-full flex flex-col gap-12 scroll-smooth px-1">
            <section id="overview">
              ...
              <p className="text-base leading-relaxed">
                {t("Blue & Breeze is a conceptual café for which I designed a delivery app focused on clarity, accessibility, and a seamless ordering experience, including customization and delivery options.")}
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-3 mt-10">
                <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20 rounded-xl p-6 w-full md:w-1/2 hover:outline-[#385BF0]">
                  ...
                  <p className="text-sm text-[#1D212A]/80">
                    {t("Customers needed a faster and easier way to order from the café without dealing with long lines or confusion.")}
                  </p>
                </div>
                <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20 rounded-xl p-6 w-full md:w-1/2 hover:outline-[#385BF0]">
                  <h3 className="text-lg font-semibold mb-2">{t("The goal")}</h3>
                  <p className="text-sm text-[#1D212A]/80">
                    {t("Create an intuitive app that would make ordering food from the café faster and more convenient for customers.")}
                  </p>
                </div>
              </div>
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20 hover:outline-[#385BF0] rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                    <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                      {t("Can you walk me through how you typically decide what to order when using a food or drink delivery app?")}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20 hover:outline-[#385BF0] rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                    <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                      {t("What kind of information do you usually look for before placing an order, and what do you do if that information isn’t available?")}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20 hover:outline-[#385BF0] rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                    <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                     {t("Have you ever needed to make a special request or note an allergy when ordering? How did you handle that, and how did it make you feel?")}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="define" className="mt-10">
              ...
              <div className="mt-12">
                ...
                <p className="text-base leading-relaxed">
                  {t("Luis is a busy young professional who needs an app that makes it quick and easy to order his favorite coffee because he doesn’t have time to wait in line or navigate a cluttered menu.")}
              </p>
              </div>
            </section>
            ...
            <section id="ideate" className="mt-10">
              ...
              <p className="text-base leading-relaxed text-[#1D212A]/90">
                  {t("Based on the research insights, I began exploring ideas to solve the key pain points through visual thinking exercises and flow planning. This phase emphasized structured creativity, allowing me to rapidly test ideas before prototyping. I focused on mapping the user’s path through the system by creating a detailed user flow, which helped me visualize each interaction and identify areas of friction or confusion. Alongside this, I developed a storyboard to better understand the user's context, emotions, and expectations at each stage of the experience.")} 
                </p>
                </div>
                <div className="lg:w-1/3 bg-[#385BF0] rounded-lg p-6 shadow-lg text-white">
              ...
              {/* STORYBOARD */}
              <div className="mt-12">
                <h3 className="text-2xl font-semibold text-indigo-500 mb-4">{t("Storyboarding")}</h3>
                <div className="flex flex-col gap-6">
                  <p className="text-base leading-relaxed text-[#1D212A]/90">
                    {t("I created a minimal storyboard from the user’s perspective to capture emotional and environmental context during the ordering journey. This narrative technique helped identify overlooked moments that impact usability.")}
                  </p>
                  <img
              ...
              {/* USER FLOW MAP */}
              <div className="mt-12">
                <h3 className="text-2xl font-semibold text-indigo-500 mb-4">{t("User Flow Map")}</h3>
                <div className="flex flex-col lg:flex-row gap-10 items-center">
                  ...
                  <div className="lg:w-1/4">
                    <p className="text-base leading-relaxed text-[#1D212A]/90">
                      {t("I mapped out the key steps a user takes from app entry to checkout. This visual overview helped uncover friction points and streamline the decision-making process to ensure a smooth experience across all stages.")}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="prototype" className="mt-10">
              ...
              <div className="flex flex-col lg:flex-row gap-10 items-start">
                <div className="lg:w-2/3">
                  <p className="text-base leading-relaxed text-[#1D212A]/90">
                    {t("After the ideation phase, I started designing simple digital wireframes to outline the app’s structure and flow. Then, I created low-fidelity and high-fidelity prototypes to test and refine the user experience. The branding was kept minimal and clean, focusing mostly on usability and clear visuals to make the app easy to navigate.")}
                  </p>
                </div>
                <div className="lg:w-1/3 bg-[#385BF0] rounded-lg p-6 shadow-lg text-white">
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-semibold text-indigo-500 mb-4">{t("Digital wireframes")} </h3>
                  <p className="text-base leading-relaxed text-[#1D212A]/90 mb-6">
                   {t("The main goal through this process was to keep a clean and simple design, so the users could navigate the app easily and place their orders without confusion or delays.")}
                  </p>
                   <img
                    src="/wireframe1.webp"
                    alt="wireframe"
                ...
                <div className="flex flex-col lg:flex-row gap-10 items-start">
                  ...
                  <div className="lg:w-1/3 bg-[#385BF0] rounded-lg p-6 shadow-lg text-white">
                    ...
                    <ul className="list-disc list-inside space-y-3 text-sm leading-relaxed">
                      ...
                      <li>{t("Identify features users expect in a coffee ordering app.")}</li>
                ...
                <div className="mt-12">
                  ...
                  <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20  rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                      <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                        {t("What challenges do users face when ordering coffee for delivery or pickup?")}
                      </p>
                    </div>
                    ...
                    <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20  rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                      <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                        {t("What kind of customization or personalization do users expect when ordering drinks?")}
                      </p>
                    </div>
                    ...
                    <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20  rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                      <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                      {t("How important is real-time tracking and order status for users?")}
                      </p>
                    </div>
                    {/* Card 4 */}
                    <div className="bg-black/[0.03] outline outline-[1.5px] outline-neutral-200/20  rounded-xl p-5 w-full lg:w-1/3 shadow-sm">
                      <p className="text-lg text-[#1D212A]/90 leading-relaxed">
                      {t("Can users complete an order successfully and intuitively using the prototype?")}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-8 border-l-4 border-indigo-600 pl-6">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#1D212A]/70 leading-relaxed text-base">
                          {t("Each user was guided through 3 main tasks: browsing the menu, customizing a drink, and completing an order.")}
                        </p>
                      </div>
                    </div>
                ...
                <div className="mt-12">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-black/[0.03] rounded-xl p-5 border border-black/10 shadow-sm text-[#1D212A]">
                      ...
                      <p className="text-[#1D212A]/80 text-base">
                        {t("“Can you show me how you'd browse available coffee options and select one that interests you?”")}
                      </p>
                    </div>

                    {/* Script Block 3 */}
                    <div className="bg-black/[0.03] rounded-xl p-5 border border-black/10 shadow-sm text-[#1D212A]">
                      <h4 className="text-lg font-semibold mb-2">{t("Task 2: Customization")}</h4>
                      <p className="text-[#1D212A]/80 text-base">
                        {t("“Try customizing the drink to your preferences—such as milk type, sugar level, or size.”")}
                      </p>
                    </div>

                    {/* Script Block 4 */}
                    <div className="bg-black/[0.03] rounded-xl p-5 border border-black/10 shadow-sm text-[#1D212A]">
                      <h4 className="text-lg font-semibold mb-2">{t("Task 3: Checkout")}</h4>
                      <p className="text-[#1D212A]/80 text-base">
                        {t("“Now complete the order as if you were doing it in real life. Feel free to comment on anything that feels unclear.”")}
                      </p>
                    </div>
                    ...
                    <div className="bg-black/[0.03] rounded-xl p-5 border border-black/10 shadow-sm text-[#1D212A]">
                      ...
                      <p className="text-[#1D212A]/80 text-base">
                        {t("“What did you enjoy about the process? Was there anything confusing or unexpected? How likely would you be to use this app?”")}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                  ...
                  <div className="lg:w-2/3 space-y-10 text-[#1D212A]/90">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-3">
                        <li>
                          {t("Users noted that the initial story-like intro felt out of place for a café app. It was replaced with a branded logo intro that better aligns with user expectations.")}
                        </li>
                        <li>
                          {t("Users found the app intuitive and visually appealing. Most participants could complete an order without assistance.")}
                        </li>
                        <li>
                          {t("It was observed that the home screen lacked direct access to the full menu. As a result, the first promotional banner was replaced with one that links directly to the menu.")}
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-3">
                        <li>
                          {t("Users showed interest in an option to pay for all pending orders together. A combined checkout feature was added.")}
                        </li>
                        <li>
                        ...
                        <li>
                          {t("Users requested clearer confirmation when a product is added to the cart. An overlay notification was implemented to address this.")}
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="lg:w-1/3 bg-indigo-600 rounded-lg p-6 shadow-lg text-white">
                    ...
                    <ul className="list-disc list-inside space-y-4">
                      <li><strong>{t("Task Completion Rate:")}</strong> {t("80% of users completed core tasks (menu navigation, filtering, cart review) without assistance")} </li>
                      <li><strong>{t("Time on Task:")}</strong>  {t("Average task completion time was 8 minutes 45 seconds")}</li>
                      <li><strong>{t("Error Rate:")}</strong> {t("Users encountered an average of 2.5 errors per session, mostly related to filter usability")}</li>
                    </ul>
                  </div>
                </div>
                </section>
                ...
                <div className="mt-16">
                  ...
                  <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-black/[0.03] border border-black/10 rounded-xl p-6 shadow-md">
                      ...
                      <p className="text-[#1D212A]/70 leading-relaxed text-base">
                        {t("Users shared highly positive feedback about the app's clarity and ease of use. One participant remarked,")}
                        <span className="italic"> {t("\"Ordering coffee has never been this easy and clear.\"")}</span>
                        {t("Although this was a course project, the design decisions made could meaningfully enhance real-world user satisfaction.")}
                      </p>
                    </div>
                    ...
                    <div className="bg-black/[0.03] border border-black/10 rounded-xl p-6 shadow-md">
                      ...
                      <p className="text-[#1D212A]/70 leading-relaxed text-base">
                        {t("This project deepened my understanding of user-centered design. I learned the value of listening to real feedback, iterating based on insights, and applying accessibility principles to create a more inclusive experience. Testing at every step helped refine both usability and aesthetics.")}
                      </p>
                    </div>
                    ...
                    <div className="bg-black/[0.03] border border-black/10 rounded-xl p-6 shadow-md">
                      ...
                      <ul className="list-disc list-inside text-[#1D212A]/70 space-y-2 text-base leading-relaxed">
                        ...
                        <li>{t("Add flexible payment options like digital wallets and installment plans.")}</li>
                        <li>{t("Explore AI-based recommendations tailored to user preferences and history.")}</li>
                      </ul>
                    </div>
                  </div>
                </div>
